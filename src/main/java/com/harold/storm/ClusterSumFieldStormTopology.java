...
public class ClusterSumFieldStormTopology {
    ...
    public static void main(String[] args) throws InvalidTopologyException, AuthorizationException, AlreadyAliveException {
        ...
        builder.setBolt("DataBout", new DataBout(), 1).fieldsGrouping("DataSourceSpout",new Fields("flag"));
        StormTopology topology = builder.createTopology();

        StormSubmitter submiter = new StormSubmitter();
        submiter.submitTopology(ClusterSumFieldStormTopology.class.getSimpleName(), new Config(), topology);
    }
}
