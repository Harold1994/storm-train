...
public class ClusterSumShuffleStormTopology {
    ...
    public static void main(String[] args) throws InvalidTopologyException, AuthorizationException, AlreadyAliveException {
        ...
        builder.setBolt("DataBout", new DataBout(), 3).shuffleGrouping("DataSourceSpout");
        StormTopology topology = builder.createTopology();

        StormSubmitter submiter = new StormSubmitter();
        submiter.submitTopology(ClusterSumShuffleStormTopology.class.getSimpleName(), new Config(), topology);
    }
}
